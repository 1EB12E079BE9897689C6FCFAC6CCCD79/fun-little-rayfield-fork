...
function RayfieldLibrary:CreateWindow(Settings)
	...
	LoadingFrame.Title.Text = Settings.LoadingTitle or "Rayfield Fork"
	LoadingFrame.Subtitle.Text = Settings.LoadingSubtitle or "made by bbvxy@whl5"
	LoadingFrame.Version.Text = "1.0.0"
